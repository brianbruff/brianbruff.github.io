...
The solution is as follows (it’s a bit rough around the edges at the moment as I have just got it working and have not yet cleaned up the code).
...
Ok so now we can see this behavior adds a MessageInspector to every message. Let’s take a look at what the message inspector does.
