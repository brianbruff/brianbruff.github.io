...
![Log4YM — Modern amateur radio logging](/images/log4ym-wiki-screenshot.png)

## The Contribution That Left a Bad Taste

I contributed some of Log4YM's features to <a href="https://openhamclock.com" target="_blank">OpenHamClock.com</a> — the dockable panels, specifically. It was warmly received. People started donating almost immediately. The maintainer even added a second donate button in the form of PayPal.
...
![The moat is being filled in](/images/agentic-2.erroding.png)
...
![Beautiful UI on top, spaghetti code underneath](/images/agentic-3.lipstick.png)
...
![Open source mutation — from thousands of tiny repos to fewer foundational systems](/images/agentic-4.mutation.png)
...
![One developer, team-sized output](/images/agentic-5.leverage.png)
