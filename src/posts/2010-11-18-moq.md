...
tags: ["unit testing", "linq"]
---

How many of you create your own mocks? I've recently been using Moq and I give it the thumbs up :-)

Note it's using .NET 3.5; time for an upgrade? I can't stress enough how much I love LINQ, today worked on a problem for a client that was using 3.0; it's a true saying "you never miss the water till the well runs dry"!
