...
When you create a new MVC project a view called Error.aspx is created for you in the Views/Shared folder.
...
```
To instruct controller actions to use this Error handler you need to use the HandleErrorAttribute action filter, this is the default exception handler present in MVC.   
...
Some points to note:
  ...
  * If no exception type is specified, then the filter handles all exceptions.
