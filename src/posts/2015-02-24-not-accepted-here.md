...
You know that message that gets scaffolded with new OData end points!? Well it explicitly tells us what entities are to be considered, so with a quick addition of my Dto Suffix in my OData config I’m back in action.

![](/images/image_thumb_364.png)  
