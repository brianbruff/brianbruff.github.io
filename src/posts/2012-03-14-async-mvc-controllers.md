...
![](/images/blog/image_thumb1_thumb.png)

Now the workflow, for the purpose of this test I won’t be connecting to any database webservice etc, I’ve just added a delay of 10 seconds and assign LastClose to RIC & " " & New Random().NextDouble()

![](/images/blog/image_thumb4_thumb.png)
...
![](/images/blog/image_thumb2_thumb.png)
...
In MVC4 it becomes even easier than my previous post on AsyncControllers, actually to me it looks quite like the WinRT async calls in .NET 4.5 and C#5.
