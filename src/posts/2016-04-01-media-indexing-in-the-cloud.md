...
So out of the blue I found myself giving Azure Media Indexing a trial run, for no other reason other than I could, this is why I love cloud tech so much, it brings something that would have been very difficult 5-10 years ago, within reach of anyone with a public cloud account.

## AWS vs Azure

Both AWS and Azure have media services, typically used to manage digital media and serve it up to consumer playback devices at scale.

AWS has the Elastic Transcode and Azure has Azure Media Services, however only Azure has the ability to dig into audio or media files and extract the text within.
...
**Note:** The source code seen above has a typo, I’ve submitted a pull request so hopefully this will be fixed, but easy to spot.   
...
![](/images/blog/image_thumb_414.png)  
...
![](/images/blog/image_thumb_415.png)  

![](/images/blog/image_thumb_416.png)  
...
![](/images/blog/image_thumb_417.png)  

![](/images/blog/image_thumb_418.png)  
  
There is no way to download the output from the portal so use the code I shared above to download the content.
...
You can find the results [here](/data/dotnetrocks_1276_news_from_build.zip), initially my knee jerk reaction was, “ah this is poor” but after reflecting on it I’m blown away by what was done and so so, sooo easily!
...
![](/images/blog/image_thumb_419.png)  
