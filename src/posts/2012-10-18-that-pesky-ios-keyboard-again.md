...
**A little tip:** is that you don’t need to set the delegate in code like my previous post, you can use the connections pane and Ctrl drag from the textbox delegate to the view controller in the Outlets section.

![](/images/blog/Screen_Shot_2012-10-18_at_12.30.27_thumb.png)   
...
![](/images/blog/Screen_Shot_2012-10-18_at_12.58.12_thumb.png)

When the keyboard presents after the textbox gains first responder status it’s now covered.

So we move the view up

![](/images/blog/image_thumb_227.png)

When we’re finished we move it back down

![](/images/blog/image_thumb_228.png)

So how did we implement this function?

![](/images/blog/image_thumb_229.png)

We change the view frame to shift the y position, and we did it in an animation to give it a little jazz... 0.6 seconds is way too slow for my liking but it does really show off the animation for demo purposes.

Here is what it ends up looking like:

![](/images/blog/Screen_Shot_2012-10-18_at_12.58.28_thumb.png)
