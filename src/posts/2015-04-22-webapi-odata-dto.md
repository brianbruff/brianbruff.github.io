...
![](/images/image_thumb_372.png)  

### Timesheet Controller

Here you can see that the underlying timesheets are just projected using Automapper to their DTO counterparts.

![](/images/image_thumb_373.png)  

### Automapper config

Here I show the automapper configuration (not that it makes any difference to the problem encountered).

![](/images/image_thumb_374.png)  

## Solution

To fix this problem I needed to set the EntityType.Name property on my OData entity type.

![](/images/image_thumb_375.png)  

And thereafter, success!

![](/images/image_thumb_376.png)  
