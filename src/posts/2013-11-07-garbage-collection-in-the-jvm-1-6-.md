...
I’ve found myself discussing garbage collecting in the JVM a few times this week and thought I’d share this information with everyone that ever wondered how all this works.
...
When a GC happens all the threads in the application are stopped in what is referred to as a “Stop the world” event. 
...
![](/images/blog/image_thumb_284.png)

Note not all JDK’s have the same structure. ![image](/images/blog/image_thumb_285.png)

_In this post I’m referring to the Sun JDK6 only. I’ve not really used the JDK7 that much except for personal projects, but even that is different with the G1 (Garbage First) and JDK8 will be a game changer again…_
...
In the simplest of terms:
  ...
  * The process repeats alternating between S0 and S1 until the objects are aged enough to become eligible for the old age pension and are promoted into the tenured generation. 
...
You will need to go to Tools/Plugins/Available Plugins and choose VisualGC (I’ve it already installed hence you see it in a different tab).

![](/images/blog/image_thumb_275.png)
...
Shows the WLS server starting up and the Eden space starting to fill. ![](/images/blog/image_thumb_276.png)

Shows the Survivor 1 getting the first aged references. ![](/images/blog/image_thumb_277.png)

Shows the minor GC’s and the alternating between S0 and S1. ![](/images/blog/image_thumb_278.png)

Shows aged survivors getting their old age pension. ![](/images/blog/image_thumb_283.png)

You can look at the monitor tab to get some more diagnostics,   
Number of threads / Classes etc

![](/images/blog/image_thumb_280.png) You can see what types of objects are holding memory. ![](/images/blog/image_thumb_281.png)
