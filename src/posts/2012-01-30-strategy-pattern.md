...
So what is the strategy pattern? It’s one of the simplest object orientated design patterns, I find that it helps clean up day to day object orientated design. Its purpose is to 
  ...
  * Separates the calculation from the delivery of its results. (separation of concerns) 
...
![](/images/blog/image_thumb_147.png)
...
![](/images/blog/image_thumb_148.png)
...
###  Strategy interface ![](/images/blog/image_thumb_149.png)

### Sample Strategy

![](/images/blog/image_thumb_150.png)

So, what is the strategy pattern again? It’s something you possibly do on a day to day basis and you don’t even realise it.

e.g. If you write ASP.MVC code, you quite likely are passing interfaces to your controllers for dependency injection and testability ---> Strategy pattern.
