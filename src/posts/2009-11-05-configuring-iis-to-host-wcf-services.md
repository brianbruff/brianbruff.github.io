...
It's true what they say, to learn new technologies it's simply a matter of ABC (Always be coding). I've watched many the video, read many the book but it's only when I went to try to do something that it sinks in.  
...
![](/images/blog/2009/11/iisWcf.png)
