...
Now: Microsoft have really been pushing out new technologies over the last number of years and a few months back I found myself saying that I would try not to dip my fingers in all the new pies as I’ve been doing over the last number of years. One of these so called pies was the Razor view engine.

However I happened to have a play around with a few Webmatrix projects and was exposed to Razor unintentionally… 

> All I can say is I’m very impressed and henceforth all my new MVC3 projects will be Razor based.

The best thing is that there is no learning curve (nearly), basically just put a “@” character before any code and away you go! Yes it’s really that simple.

e.g.

![](/images/blog/image_thumb_7.png)

###### Shows the controller setting a value on the ViewBag (a dynamic property .NET 4)

![](/images/blog/image_thumb_8.png)

###### Shows the client page rendering the text, also shows the new Layout mechanism for Razor.

![](/images/blog/image_thumb_9.png)

###### Important part is the @RenderBody(); note the DOCTYPE too HTML5…
